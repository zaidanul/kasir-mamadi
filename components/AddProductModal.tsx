        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <div 
                className={`relative flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed ${previewUrl ? 'border-blue-500/50 bg-blue-500/5' : 'border-zinc-700 bg-[#1e293b] hover:border-zinc-500 hover:bg-[#283548]'} p-6 transition-all`}
              ...
              >
                ...
                {previewUrl ? (
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <span className="text-xs text-blue-400 font-medium bg-blue-500/10 px-2.5 py-1 rounded-full">{imageFile?.name}</span>
                  </div>
                ) : (
